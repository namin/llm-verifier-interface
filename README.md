...
- [AlphaProof Nexus](https://arxiv.org/abs/2605.22763): Lean proof-search agents built from [Ralph loops](https://ghuntley.com/ralph/): LLM subagents edit proof sketches, Lean gives compiler feedback, and the full system adds AlphaProof plus an evolutionary archive of validated sketches.
...
- [POETRY](https://openreview.net/forum?id=yAa5l92TtQ): recursive level-by-level proving: sketch with `sorry` placeholders, then solve each hole; the longest proof found grows from 10 to 26 lines
...
- [DeepSeek-Prover-V2](https://arxiv.org/abs/2504.21801): subgoal decomposition bootstraps the training data, then reinforcement learning with Lean's verdict as the reward; open weights
