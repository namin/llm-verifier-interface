...
- [AlphaProof Nexus](https://arxiv.org/abs/2605.22763): a agent framework with each subagent (no shared state) consisting of a [ralph loop](https://ghuntley.com/ralph/)
